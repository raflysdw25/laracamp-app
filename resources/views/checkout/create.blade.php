                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="email" type="email" class="form-control" id="email_address" value="{{ Auth::user()->email }}" disabled>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="expired" type="month" class="form-control" id="expired_date">
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <label for="cvc_number" class="form-label">CVC</label>
                                        <input name="cvc" type="text" class="form-control" id="cvc_number" maxlength="3">
                                    </div>
                                </div>
                            </div>
