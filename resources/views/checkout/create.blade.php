                        ...
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="name" type="text"
                                    class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="fullname"
                                    value="{{ Auth::user()->name }}" required>
                                {{-- Untuk check apakah variable global $errors memiliki attribute name --}}
                                @if ($errors->has('name'))
                            ...
                            <div class="mb-4">
                                ...
                                <input name="occupation" type="text"
                                    class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="occupation"
                            ...
                            <div class="mb-4">
                                ...
                                <input name="card_number" type="number"
                                    ...
                                    id="card_number" value="{{ old('card_number') ?: '' }}" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="expired" type="month"
                                            ...
                                            id="expired_date" required value="{{ old('expired') ?: '' }}">
                                        @if ($errors->has('expired'))
                                        <p class="text-danger">{{ $errors->first('expired') }}</p>
                                        @endif
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <label for="cvc_number" class="form-label">CVC</label>
                                        <input name="cvc" type="text"
                                            class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}"
                                            id="cvc_number" maxlength="3" value="{{ old('cvc') ?: '' }}" required>
                                        @if ($errors->has('cvc'))
